...
use roseui_extension::{ExtensionSource, ScanPath, filter_by_engine_compatibility, load_all};
...
fn write_manifest_full(dir: &Path, name: &str, version: &str, engine_roseui: Option<&str>, api_version: Option<&str>) {
...
fn el2_engine_incompatible_extension_filtered_out() {
    ...
    // Extension requires roseui ^2.0.0 but app is 1.5.0.
...
//
// Since ROSEUI_E2E_TEST=1 changes the behaviour of resolve_scan_paths()
