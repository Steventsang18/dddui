...
const EXTENSION_STATES_FILE_ENV: &str = "ROSEUI_EXTENSION_STATES_FILE";
...
/// Resolve the extension state file path using the historical RoseUi rules.
///
/// Priority:
/// 1. `ROSEUI_EXTENSION_STATES_FILE`
