...
pub enum SessionEvent {
    ...
    // (No clock/timeout lower: DoDidDoneUi does NOT auto-time-out a turn. A user may
    ...
    Detached {
        ...
        /// the 14-keyword allowlist in `roseui_common::error_extract` survive,
    ...
    Permission {
        ...
        /// `{ "server_name": "roseui-team"?, "options": [{"option_id","kind"}] }`.
        ...
        /// AskUserQuestion `{questions:[…]}` — RoseUi issue #3779: without it the
...
mod additive_tests {
    ...
    fn additive_defaults_keep_old_frames_deserializable() {
        ...
        let new_p = r#"{"Permission":{"request_id":"r","kind":"Tool","metadata":{"server_name":"roseui-team"}}}"#;
