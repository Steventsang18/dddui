...
use roseui_ai_agent::AgentRegistry;
use roseui_ai_agent::agent_task::AgentInstance;
use roseui_ai_agent::types::BuildTaskOptions;
...
use roseui_common::{PaginatedResult, ProviderWithModel, TimestampMs, now_ms};
use roseui_conversation::ConversationService;
use roseui_cron::{CronRouterState, cron_routes};
use roseui_db::{
...
use roseui_cron::events::CronEventEmitter;
use roseui_cron::executor::JobExecutor;
use roseui_cron::scheduler::CronScheduler;
use roseui_cron::service::{CronService, CronServiceDeps};
use roseui_cron::types::CronAgentConfig;
use roseui_cron::types::JobStatus;
...
fn current_user(id: &str) -> CurrentUser {
    CurrentUser {
        ...
        user_type: roseui_db::UserType::Local,
        status: roseui_db::UserStatus::Active,
    }
}

async fn seed_sqlite_conversations(db: &roseui_db::Database, conversation_ids: &[&str]) {
    sqlx::query(
    ...
    for conversation_id in conversation_ids {
        repo.create(&roseui_db::models::ConversationRow {
...
impl roseui_ai_agent::task_manager::IWorkerTaskManager for StubTaskManager {
    ...
    async fn get_or_build_task(
        ...
        _: &str,
        _: BuildTaskOptions,
    ) -> Result<AgentInstance, roseui_ai_agent::AgentError> {
        Err(roseui_ai_agent::AgentError::internal("stub"))
    }
    fn kill(&self, _: &str, _: Option<roseui_common::AgentKillReason>) -> Result<(), roseui_ai_agent::AgentError> {
        Ok(())
    }
    fn kill_and_wait(
        &self,
        _: &str,
        _: Option<roseui_common::AgentKillReason>,
...
struct StubConvRepo {
    ...
    artifacts: Mutex<Vec<roseui_db::ConversationArtifactRow>>,
    rows: Mutex<HashMap<String, roseui_db::models::ConversationRow>>,
    assistant_snapshots: Mutex<HashMap<String, ConversationAssistantSnapshotRow>>,
    update_failures: Mutex<Vec<String>>,
    sqlite_pool: roseui_db::SqlitePool,
}

impl StubConvRepo {
    fn new(sqlite_pool: roseui_db::SqlitePool) -> Self {
        Self {
    ...
    async fn seed_sqlite_row(&self, row: &roseui_db::models::ConversationRow) -> Result<(), roseui_db::DbError> {
    ...
    fn upsert_artifact_row(&self, artifact: roseui_db::ConversationArtifactRow) {
    ...
    fn artifacts(&self) -> Vec<roseui_db::ConversationArtifactRow> {
    ...
    fn set_conversation_extra(&self, conversation_id: &str, extra: serde_json::Value) {
        ...
        let row = rows
            ...
            .or_insert_with(|| roseui_db::models::ConversationRow {
                id: conversation_id.to_owned(),
                user_id: "u1".into(),
                name: "stub".into(),
                r#type: "default".into(),
...
impl IConversationRepository for StubConvRepo {
    async fn get(
        ...
        user_id: &str,
        id: &str,
    ) -> Result<Option<roseui_db::models::ConversationRow>, roseui_db::DbError> {
        ...
        let row = if id == "conv_mode" {
            roseui_db::models::ConversationRow {
                id: id.into(),
                user_id: "u1".into(),
                ...
                extra: serde_json::json!({
                    "backend": "gemini",
                    "agent_name": "Gemini",
                    "workspace": ensure_named_workspace_path("roseui-cron-service-gemini-workspace"),
                    "session_mode": "yolo",
            ...
            roseui_db::models::ConversationRow {
                ...
                extra: serde_json::json!({
                    "backend": "hermes",
                    "agent_name": "Hermes",
                    "workspace": ensure_named_workspace_path("roseui-cron-service-hermes-workspace"),
            ...
            roseui_db::models::ConversationRow {
                ...
                extra: serde_json::json!({
                    "backend": "gemini",
                    "agent_name": "Gemini",
                    "workspace": ensure_named_workspace_path("roseui-cron-service-gemini-default-workspace"),
                    "session_mode": "default",
                    "current_model_id": "gemini-2.5-pro"
                })
                .to_string(),
            ...
            roseui_db::models::ConversationRow {
                ...
                extra: serde_json::json!({
                    "backend": "codex",
                    "agent_name": "Codex",
                    "workspace": ensure_named_workspace_path("roseui-cron-service-codex-workspace"),
                    "session_mode": "default",
            ...
            roseui_db::models::ConversationRow {
                ...
                extra: serde_json::json!({
                    "backend": "claude",
                    "agent_name": "Claude",
                    "workspace": ensure_named_workspace_path("roseui-cron-service-claude-workspace"),
                    "session_mode": "default",
            ...
            roseui_db::models::ConversationRow {
                ...
                extra: serde_json::json!({
                    "backend": "claude",
                    "agent_name": "Gemini",
                    "workspace": ensure_named_workspace_path("roseui-cron-service-stale-backend-workspace"),
                    "session_mode": "yolo",
                    "current_model_id": "gemini-2.5-pro"
                })
                .to_string(),
            ...
            roseui_db::models::ConversationRow {
                ...
                extra: serde_json::json!({
                    "backend": "anthropic",
                    "agent_name": "Aion CLI",
                    "workspace": ensure_named_workspace_path("roseui-cron-service-aionrs-workspace"),
                    "session_mode": "default",
                    "current_model_id": "claude-sonnet-4-20250514"
                })
                .to_string(),
            ...
            roseui_db::models::ConversationRow {
                ...
                extra: serde_json::json!({
                    ...
                    "workspace": ensure_named_workspace_path("roseui-cron-service-assistant-stale-backend-workspace"),
            ...
            roseui_db::models::ConversationRow {
                ...
                extra: serde_json::json!({
                    ...
                    "workspace": ensure_named_workspace_path("roseui-cron-service-missing-assistant-stale-backend-workspace")
                })
                .to_string(),
                pinned: false,
                pinned_at: None,
            ...
            roseui_db::models::ConversationRow {
                ...
                extra: serde_json::json!({
                    ...
                    "workspace": ensure_named_workspace_path("roseui-cron-service-assistant-snapshot-workspace")
                })
                .to_string(),
                pinned: false,
                pinned_at: None,
    ...
    async fn owner_user_id(&self, id: &str) -> Result<Option<String>, roseui_db::DbError> {
    ...
    async fn get_assistant_snapshot(
        ...
        _user_id: &str,
        conversation_id: &str,
    ) -> Result<Option<ConversationAssistantSnapshotRow>, roseui_db::DbError> {
    ...
    async fn create(&self, row: &roseui_db::models::ConversationRow) -> Result<(), roseui_db::DbError> {
    ...
    ) -> Result<(), roseui_db::DbError> {
        if self.update_failures.lock().unwrap().iter().any(|item| item == id) {
            return Err(roseui_db::DbError::Init(format!("forced update failure for {id}")));
        }
    ...
    async fn delete(&self, _user_id: &str, _id: &str) -> Result<(), roseui_db::DbError> {
        Ok(())
    }
    ...
    ) -> Result<PaginatedResult<roseui_db::models::ConversationRow>, roseui_db::DbError> {
        Ok(PaginatedResult {
            items: vec![],
            total: 0,
            has_more: false,
    ...
    async fn list_by_cron_job(
        ...
        _user_id: &str,
        cron_job_id: &str,
    ) -> Result<Vec<roseui_db::models::ConversationRow>, roseui_db::DbError> {
    ...
    ) -> Result<MessagePageResult, roseui_db::DbError> {
    ...
    async fn insert_message(
        &self,
        _user_id: &str,
        message: &roseui_db::models::MessageRow,
    ) -> Result<(), roseui_db::DbError> {
    ...
    async fn delete_messages_by_conversation(&self, _user_id: &str, _conv_id: &str) -> Result<(), roseui_db::DbError> {
        Ok(())
    }
    async fn get_message_by_msg_id(
        ...
        _msg_id: &str,
        _msg_type: &str,
    ) -> Result<Option<roseui_db::models::MessageRow>, roseui_db::DbError> {
        Ok(None)
    }
    async fn search_messages(
        ...
        _page: u32,
        _page_size: u32,
    ) -> Result<PaginatedResult<MessageSearchRow>, roseui_db::DbError> {
        Ok(PaginatedResult {
            items: vec![],
            total: 0,
            has_more: false,
    ...
    async fn list_artifacts(
        ...
        _user_id: &str,
        conversation_id: &str,
    ) -> Result<Vec<roseui_db::ConversationArtifactRow>, roseui_db::DbError> {
        Ok(self
            .artifacts
            .lock()
            .unwrap()
    ...
    async fn get_artifact(
        ...
        conversation_id: &str,
        artifact_id: &str,
    ) -> Result<Option<roseui_db::ConversationArtifactRow>, roseui_db::DbError> {
        Ok(self
            .artifacts
            .lock()
            .unwrap()
    ...
    async fn upsert_artifact(
        &self,
        _user_id: &str,
        artifact: &roseui_db::ConversationArtifactRow,
    ) -> Result<roseui_db::ConversationArtifactRow, roseui_db::DbError> {
...
async fn setup_with_conv_runtime_and_agent_metadata() -> (
    ...
    Arc<dyn roseui_db::ISkillRepository>,
) {
    ...
    let data_dir = std::env::temp_dir().join(format!("roseui-cron-test-{}", now_ms()));
    std::fs::create_dir_all(&data_dir).unwrap();

    struct StubSkillResolver;
    #[async_trait::async_trait]
    impl roseui_conversation::skill_resolver::SkillResolver for StubSkillResolver {
        ...
        async fn resolve_skills(
            &self,
            _names: &[String],
        ) -> Vec<roseui_conversation::skill_resolver::ResolvedAgentSkill> {
            Vec::new()
        }
        ...
        async fn link_workspace_skills(
            ...
            _rel_dirs: &[&str],
            _skills: &[roseui_conversation::skill_resolver::ResolvedAgentSkill],
        ) -> usize {
            0
        }
    }
    ...
    let task_manager: Arc<dyn roseui_ai_agent::task_manager::IWorkerTaskManager> = Arc::new(StubTaskManager);
    ...
    let skill_repo: Arc<dyn roseui_db::ISkillRepository> = Arc::new(SqliteSkillRepository::new(pool.clone()));
...
async fn setup_with_skill_repo() -> (CronService, Arc<dyn roseui_db::ISkillRepository>) {
...
fn make_create_req(name: &str, schedule: CronScheduleDto) -> CreateCronJobRequest {
    CreateCronJobRequest {
        ...
        execution_mode: None,
        queue_enabled: false,
        agent_config: Some(roseui_api_types::CronAgentConfigWriteDto {
...
async fn create_job_strips_legacy_agent_ids_when_assistant_id_present() {
    ...
    req.agent_config = Some(roseui_api_types::CronAgentConfigWriteDto {
        name: "Helper".into(),
        cli_path: None,
...
async fn create_job_requires_assistant_id_for_new_jobs() {
    ...
    assert!(matches!(err, roseui_cron::error::CronError::InvalidAgentConfig(_)));
...
async fn cj5_get_nonexistent_job() {
    ...
    assert!(matches!(err, roseui_cron::error::CronError::JobNotFound(_)));
}
...
async fn update_existing_conversation_job_rejects_agent_config_changes() {
    ...
    assert!(
        matches!(err, roseui_cron::error::CronError::InvalidAgentConfig(message) if message.contains("ongoing conversation"))
    );
}
...
async fn update_existing_job_to_new_conversation_preserves_custom_workspace() {
    ...
    let custom_workspace = ensure_named_workspace_path(&format!("roseui-cron-switch-custom-{conversation_id}"));
    conv_repo.set_conversation_extra(
        &conversation_id,
        serde_json::json!({
...
async fn update_team_conversation_job_rejects_execution_mode_change() {
    ...
    conv_repo.set_conversation_extra(
        ...
        serde_json::json!({
            "team_id": "team-1",
            "workspace": ensure_named_workspace_path("roseui-cron-service-team-workspace")
        }),
    );
    let created = svc.add_job("u1", create_req).await.unwrap();
    ...
    let err = svc.update_job("u1", &created.id, req).await.unwrap_err();
    assert!(matches!(err, roseui_cron::error::CronError::InvalidExecutionMode(message) if message.contains("Team")));
}
...
async fn cj9_update_schedule_type() {
    ...
    assert!(matches!(
        updated.schedule,
        roseui_cron::types::CronSchedule::Cron { .. }
    ));
...
async fn cj12_delete_nonexistent() {
    ...
    assert!(matches!(
        err,
        roseui_cron::error::CronError::Database(roseui_db::DbError::NotFound(_))
    ));
}
...
async fn sk1_1_save_skill_marks_related_skill_suggest_artifacts_saved() {
    ...
    conv_repo.upsert_artifact_row(roseui_db::ConversationArtifactRow {
...
async fn sk4_save_empty_skill() {
    ...
    let err = svc
        ...
        .await
        .unwrap_err();
    assert!(matches!(err, roseui_cron::error::CronError::InvalidSkillContent(_)));
}
...
async fn sc5_invalid_cron_expression() {
    ...
    let err = svc.add_job("u1", req).await.unwrap_err();
    assert!(matches!(err, roseui_cron::error::CronError::InvalidCronExpression(_)));
}
...
async fn sc7_every_zero_interval() {
    ...
    let err = svc.add_job("u1", req).await.unwrap_err();
    assert!(matches!(err, roseui_cron::error::CronError::InvalidSchedule(_)));
}
...
async fn oc1_rejects_lazy_existing_jobs() {
    ...
    let err = svc.add_job("u1", req).await.unwrap_err();
    assert!(matches!(err, roseui_cron::error::CronError::Conversation(_)));
}
...
async fn oc2b_rejects_existing_jobs_with_cross_user_conversation_code() {
    ...
    .unwrap();
    conv_repo
        .create(&roseui_db::models::ConversationRow {
    ...
    assert!(matches!(
        err,
        roseui_cron::error::CronError::CrossAccountReference(message)
...
async fn create_for_conversation_helper_fails_when_conversation_binding_fails() {
    ...
    assert!(matches!(err, roseui_cron::error::CronError::Database(_)));
    ...
    let response = app
        ...
        .oneshot(
            Request::builder()
                ...
                .header("x-roseui-user-id", "u1")
                .header("x-roseui-conversation-id", "conv_1")
                .body(Body::from(
...
async fn conversation_cron_routes_reject_missing_headers_unclaimed_and_wrong_user() {
    ...
    assert!(body.contains("x-roseui-user-id"));
    ...
    let wrong_user = app
        .oneshot(
            Request::builder()
                ...
                .uri("/api/internal/conversation-cron/create")
                .header("content-type", "application/json")
                .header("x-roseui-user-id", "other_user")
                .header("x-roseui-conversation-id", "conv_1")
                .body(Body::from(
                    serde_json::to_vec(&conversation_cron_request("hello")).unwrap(),
                ))
...
async fn sr1_system_resume_missed_job() {
    ...
    let params = roseui_db::UpdateCronJobParams {
...
async fn cd3c_on_conversation_delete_preserves_custom_workspace_on_jobs() {
    ...
    let custom_workspace = ensure_named_workspace_path(&format!("roseui-cron-custom-workspace-{conversation_id}"));
    conv_repo.set_conversation_extra(
        &conversation_id,
        serde_json::json!({
            "workspace": custom_workspace,
