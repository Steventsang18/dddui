...
//!
//! Lives in its own subdir `{data_dir}/runtime/roseui-process/registry.json`,
...
pub const SUBDIR: &str = "runtime/roseui-process";
...
/// File-backed registry under `{data_dir}/runtime/roseui-process/registry.json`.
