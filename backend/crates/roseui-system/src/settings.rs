...
use roseui_api_types::{SystemSettingsResponse, UpdateSettingsRequest};
use roseui_db::ISettingsRepository;
...
mod tests {
    ...
    use roseui_db::{SqliteSettingsRepository, init_database_memory};
