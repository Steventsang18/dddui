...
use roseui_api_types::{ClientPreferencesResponse, UpdateClientPreferencesRequest};
use roseui_db::IClientPreferenceRepository;
...
mod tests {
    ...
    use roseui_db::{SqliteClientPreferenceRepository, init_database_memory};
    use serde_json::json;
    use std::io::Write;
