use roseui_api_types::{GitHubReleaseAsset, UpdateCheckRequest, UpdateCheckResult, UpdateReleaseInfo};
use serde::Deserialize;

use crate::error::SystemError;

const DEFAULT_REPO: &str = "Steventsang18/dddui";
...
fn resolve_repo(from_request: Option<&str>) -> String {
    ...
    if let Ok(v) = std::env::var("ROSEUI_GITHUB_REPO")
        && !v.is_empty()
    {
        return v;
    }
