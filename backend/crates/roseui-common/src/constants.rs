...
pub const ROSEUI_TIMESTAMP_SEPARATOR: &str = "_roseui_";
pub const ROSEUI_FILES_MARKER: &str = "[[AION_FILES]]";
...
pub const COOKIE_NAME: &str = "roseui-session";
pub const COOKIE_MAX_AGE_DAYS: u32 = 30;
pub const CSRF_COOKIE_NAME: &str = "roseui-csrf-token";
