...
//!
//! Hooks defined here let lower-layer crates (e.g. `roseui-ai-agent`,
//! `roseui-cron`) react to events owned by higher-layer crates (e.g.
//! `roseui-conversation`) without forming a dependency cycle.
