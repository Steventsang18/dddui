...
const ACP_CLIENT_NAME: &str = "RoseUi";
...
/// Log a JSON-RPC request from RoseUi to the ACP agent.
...
/// Log a fire-and-forget notification from RoseUi to the agent.
...
/// Log a JSON-RPC response from RoseUi back to the agent.
...
mod tests {
    ...
    fn initialize_request_sends_non_empty_client_info() {
        ...
        assert_eq!(client_info.name, "RoseUi");
        ...
        assert_eq!(json["clientInfo"]["name"], "RoseUi");
