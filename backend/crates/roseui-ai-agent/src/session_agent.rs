...
use roseui_common::{AgentKillReason, ConversationStatus, TimestampMs, now_ms};
use roseui_session::{
...
use roseui_db::{IAcpSessionRepository, IMcpServerRepository, SaveRuntimeStateParams};
...
fn resolve_current_model_efforts(models: &[roseui_session::ModelInfo], current_model: Option<&str>) -> Vec<String> {
...
struct CatalogPreload {
    available_models: Vec<roseui_session::ModelInfo>,
    current_model: Option<String>,
    available_modes: Vec<roseui_session::ModeInfo>,
...
impl CatalogPreload {
    ...
    fn from_handshake(handshake: &roseui_api_types::AgentHandshake) -> Self {
...
fn build_session_cli_config_dump_value(backend: &str, cfg: &roseui_session::SessionConfig) -> serde_json::Value {
...
fn session_server_to_spec(server: &roseui_api_types::SessionMcpServer) -> roseui_session::McpServerSpec {
...
fn team_mcp_server_spec(cfg: &roseui_api_types::TeamMcpStdioConfig) -> roseui_session::McpServerSpec {
...
fn wiki_mcp_server_spec(cfg: &roseui_api_types::WikiMcpStdioConfig) -> roseui_session::McpServerSpec {
    roseui_session::McpServerSpec {
...
/// going empty).
fn catalog_partial_from_caps(caps: &roseui_session::Capabilities) -> Option<roseui_api_types::AgentHandshake> {
    let mut config_options = Vec::new();
...
fn empty_turn_tip(outcome: &roseui_session::TurnOutcome) -> Option<TipsEventData> {
