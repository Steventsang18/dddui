...
use roseui_api_types::{BrowseDirectoryResponse, BrowseEntry};
...
/// projects (iOfficeAI/RoseUi#3191) — so strip the prefix before serializing.
...
mod tests {
    ...
    // Regression tests for iOfficeAI/RoseUi#3191: responses must never carry
