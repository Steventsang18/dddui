...
impl TeamAgentProvisioner {
    ...
    /// prompts the agent to shell out to `$ROSEUI_HELPER_BIN team ...`.
...
mod tests {
    ...
    fn test_mcp_config() -> TeamMcpStdioConfig {
        TeamMcpStdioConfig {
            ...
            token: "token".into(),
            slot_id: "slot-1".into(),
            binary_path: "/tmp/dodiddoneui".into(),
        }
    }
