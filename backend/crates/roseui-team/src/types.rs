...
use roseui_api_types::{TeamAgentResponse, TeamResponse};
...
mod tests {
    ...
    #[test]
    fn teammate_status_parse_roseui_aliases() {
    ...
    #[test]
    fn teammate_status_serde_roseui_aliases() {
    ...
    #[test]
    fn team_agent_deserialize_roseui_format() {
