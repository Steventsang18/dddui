...
use roseui_team::events::TeamEventEmitter;
use roseui_team::message_projection::{
    ProjectedTeamMessage, TeamMessageProjection, TeamProjectionMessageStore, TeamProjectionRequest,
    TeamProjectionSource,
};
use roseui_team::prompts::{AvailableAssistant, build_lead_prompt, build_teammate_prompt, build_wake_payload};
use roseui_team::types::{
...
fn lp2_lead_prompt_contains_tool_descriptions() {
    ...
    // RoseUi lead prompt references the `team_*` coordination tools that the
