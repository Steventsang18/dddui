//! Integration tests for roseui-mcp core types.
//!
...
use roseui_mcp::{McpServer, McpServerTransport, McpTool};
...
fn tool_fields_preserved_through_conversion() {
    ...
    // Domain -> API response
    let resp: roseui_api_types::McpToolResponse = tool.clone().into();
