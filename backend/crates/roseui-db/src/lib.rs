...
pub use database::{
    ...
    init_database_staged_with_options, init_database_with_options, maybe_copy_legacy_database, sqlite_has_fts5,
};
pub use error::{
...
pub use legacy_handoff::{MigrateReport, TableCount, migrate_from_electron};
...
pub use repository::{
    ...
    IConversationRepository, ICronRepository, IFeedbackDiagnosticsRepository, IIndustryTemplateRepository,
    IMcpServerRepository, IOAuthTokenRepository, IProjectStore, IProviderRepository, IRemoteAgentRepository,
    ISettingsRepository, ISkillRepository, ITeamRepository, IUserRepository, PersistedSessionState, SaveRuntimeStateParams,
    ...
    SqliteCronRepository, SqliteFeedbackDiagnosticsRepository, SqliteIndustryTemplateRepository,
    SqliteMcpServerRepository, SqliteOAuthTokenRepository,
