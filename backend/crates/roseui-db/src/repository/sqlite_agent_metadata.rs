...
struct AgentMetadataSafeRow {
    ...
    last_check_at: Option<roseui_common::TimestampMs>,
    last_success_at: Option<roseui_common::TimestampMs>,
    last_failure_at: Option<roseui_common::TimestampMs>,
    command_override: Option<String>,
    env_override: Option<String>,
    created_at: roseui_common::TimestampMs,
    updated_at: roseui_common::TimestampMs,
}
...
mod tests {
    ...
    async fn seed_rows_populated_after_migrations() {
        ...
        assert!(
            rows.iter()
                .any(|r| r.name == "DDDcli" && r.agent_source == "internal")
        );
    ...
    async fn seed_rows_include_icon_backfill() {
        ...
        assert_eq!(aionrs.icon.as_deref(), Some("/api/assets/logos/brand/app.png"));
