...
use roseui_db::{DbError, IChannelRepository, SqliteChannelRepository, UpdatePluginStatusParams, init_database_memory};

const OWNER_ID: &str = "system_default_user";

async fn repo() -> (Arc<dyn IChannelRepository>, roseui_db::Database) {
