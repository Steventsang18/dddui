//! Agent-readable capability contract for `dodiddoneui config`.

use serde_json::{Value, json};

const RUNTIME_ENV: [&str; 3] = ["ROSEUI_BASE_URL", "ROSEUI_CONVERSATION_ID", "ROSEUI_USER_ID"];
...
pub(crate) fn data() -> Value {
    json!({
        ...
        "input": {
            ...
            "selectors": {
                "assistant_id": {
                    "current": "resolve via ROSEUI_CONVERSATION_ID",
                ...
                "user_id": {
                    ...
                    "literal": "ignored and replaced with ROSEUI_USER_ID"
                }
            }
        },
        "output": {
