//! Agent-readable capability contract for `dodiddoneui diagnose`.
...
pub(crate) fn data() -> Value {
    json!({
        ...
        "runtime_context": {
            ...
            "optional_environment": ["ROSEUI_LOG_DIR"]
        },
        "safety": {
            "read_only": true,
            "redacted_by_default": [
        ...
        "domains": [
            ...
            domain("logs", &[
                command(CommandDescriptor {
                    path: &["logs", "tail"],
                    description: "Tail dodiddoneui logs from ROSEUI_LOG_DIR or stdin log_dir.",
                    input: "stdin_json",
