//! Subcommand implementations for the `dodiddoneui` binary.
//!
...
pub(crate) use cmd_migrate::run_migrate;
...
pub(crate) use cmd_wiki_stdio::run_wiki_stdio;
