...
use roseui_common::{AgentType, ConversationStatus, ErrorChain, now_ms};
...
use roseui_api_types::AgentErrorCode;
...
/// `roseui_common::enums`). What cron's forced full-auto — and a resumed full-access
...
async fn apply_required_runtime_mode(
    ...
    // it look-before-leap. This logic is sunk into roseui-ai-agent because the
