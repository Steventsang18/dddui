...
impl ChannelSettingsService {
    ...
    async fn effective_assistant_backend(
        &self,
        user_id: &str,
        definition: &roseui_db::models::AssistantDefinitionRow,
        overlays: &[roseui_db::models::AssistantOverlayRow],
...
mod tests {
    ...
    use roseui_db::{IAssistantDefinitionRepository, IAssistantOverlayRepository};
    use std::sync::Mutex;
