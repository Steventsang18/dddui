...
use roseui_ai_agent::{AgentStreamEvent, IWorkerTaskManager};
use roseui_api_types::{AssistantConversationRequest, CreateConversationRequest, SendMessageRequest};
use roseui_common::{AgentType, ConversationSource};
...
fn platform_to_source(platform: PluginType) -> ConversationSource {
    match platform {
        ...
        // Reserved variants default to Roseui
        PluginType::Slack | PluginType::Discord => ConversationSource::Roseui,
    }
}
...
mod tests {
    ...
    #[test]
    fn platform_to_source_reserved_defaults_to_roseui() {
        assert_eq!(platform_to_source(PluginType::Slack), ConversationSource::Roseui);
        assert_eq!(platform_to_source(PluginType::Discord), ConversationSource::Roseui);
    }
