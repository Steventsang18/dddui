...
use dashmap::DashMap;
use roseui_api_types::{PluginStatusChangedPayload, PluginStatusResponse, WebSocketMessage};
use roseui_common::{decrypt_string, encrypt_string, now_ms};
use roseui_db::models::ChannelPluginRow;
use roseui_db::{IChannelRepository, UpdatePluginStatusParams};
...
mod tests {
    ...
    use roseui_db::models::{AssistantSessionRow, AssistantUserRow, ChannelPluginRow, PairingCodeRow};
    use roseui_db::{DbError, IChannelRepository, UpdatePluginStatusParams};
