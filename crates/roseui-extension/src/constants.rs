...
/// Well-known skill source name for the roseui skills market.
pub const SKILLS_MARKET_NAME: &str = "roseui-skills";

/// Well-known skill source path for the roseui skills market.
///
...
pub const SKILLS_MARKET_PATH: &str = "https://github.com/AionUI/roseui-skills";
