...
///
/// Data is stored in `~/.roseui/custom-skill-paths.json`.
...
impl ExternalPathsManager {
    ...
    /// Enable the roseui skills market by adding it to external paths.
    ...
    /// Disable the roseui skills market by removing it from external paths.
