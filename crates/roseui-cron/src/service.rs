...
impl CronService {
    ...
    async fn verify_conversation_helper_context(
        ...
        user_id: &str,
        conversation_id: &str,
    ) -> Result<roseui_db::models::ConversationRow, CronError> {
        ...
        self.executor
            ...
            .await?
            .ok_or_else(|| {
                CronError::Conversation(roseui_conversation::ConversationError::NotFound {
    ...
    async fn resolve_new_job_agent_type(
        &self,
        user_id: &str,
        agent_config: Option<&roseui_api_types::CronAgentConfigWriteDto>,
    ...
    async fn require_existing_conversation_scope(&self, user_id: &str, conversation_id: &str) -> Result<(), CronError> {
        if conversation_id.is_empty() {
            return Err(CronError::Conversation(
                roseui_conversation::ConversationError::NotFound {
                    id: conversation_id.to_owned(),
                },
            ));
        }
    ...
    async fn build_agent_config_from_conversation(
        ...
        String,
        Option<roseui_api_types::CronAgentConfigWriteDto>,
        Option<String>,
    ) {
        ...
        // (Sentry ELECTRON-1HM).
        let model_resolved = roseui_conversation::task_options::provider_model_from_conversation_row(row);
        ...
        let agent_config = roseui_api_types::CronAgentConfigWriteDto {
            name: assistant_name
    ...
    async fn build_cron_agent_config(
        ...
        config: roseui_api_types::CronAgentConfigWriteDto,
...
impl roseui_common::OnConversationDelete for CronService {
...
fn sanitize_agent_config_dto(
    mut config: roseui_api_types::CronAgentConfigWriteDto,
) -> roseui_api_types::CronAgentConfigWriteDto {
...
mod tests {
    ...
    fn agent_cfg_dto(provider_id: &str) -> roseui_api_types::CronAgentConfigWriteDto {
        roseui_api_types::CronAgentConfigWriteDto {
            name: "provider".into(),
            cli_path: None,
    ...
    fn sanitize_agent_config_dto_clears_legacy_ids_when_assistant_id_present() {
        let config = roseui_api_types::CronAgentConfigWriteDto {
            name: "Helper".into(),
            cli_path: None,
            assistant_id: Some("assistant-1".into()),
    ...
    fn sanitize_agent_config_dto_rejects_legacy_custom_agent_id_without_assistant_id() {
        let err = serde_json::from_value::<roseui_api_types::CronAgentConfigWriteDto>(serde_json::json!({
            "name": "Helper",
