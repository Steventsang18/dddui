...
//! reachable through `roseui_ai_agent::manager::acp`. It proves nothing about
...
use roseui_ai_agent::manager::acp::{AcpSession, AcpSessionEvent, CatalogForwarder, PermissionRouter, ReconcileAction};
use roseui_ai_agent::shared_kernel::PersistedSessionState;
