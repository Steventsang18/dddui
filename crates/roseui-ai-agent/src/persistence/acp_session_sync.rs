...
use roseui_db::{IAcpSessionRepository, SaveRuntimeStateParams};
...
impl AcpSessionSyncService {
    ...
    pub async fn load_persisted(
        ...
        user_id: &str,
        conversation_id: &str,
    ) -> Option<roseui_db::PersistedSessionState> {
...
mod tests {
    ...
    use roseui_db::{CreateAcpSessionParams, SqliteAcpSessionRepository, init_database_memory};
