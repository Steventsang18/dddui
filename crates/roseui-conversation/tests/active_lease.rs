...
use roseui_ai_agent::{ActiveLeaseRegistry, AgentError, IWorkerTaskManager};
use roseui_api_types::{CreateConversationRequest, WebSocketMessage};
use roseui_common::{AgentKillReason, TimestampMs};
