...
fn map_phase(phase: roseui_runtime::NodeRuntimeProgressPhase) -> RuntimeStatusPhase {
    match phase {
        roseui_runtime::NodeRuntimeProgressPhase::WaitingForLock => RuntimeStatusPhase::WaitingForLock,
        roseui_runtime::NodeRuntimeProgressPhase::Downloading => RuntimeStatusPhase::Downloading,
        roseui_runtime::NodeRuntimeProgressPhase::Extracting => RuntimeStatusPhase::Extracting,
        roseui_runtime::NodeRuntimeProgressPhase::Validating => RuntimeStatusPhase::Validating,
        roseui_runtime::NodeRuntimeProgressPhase::Ready => RuntimeStatusPhase::Ready,
        roseui_runtime::NodeRuntimeProgressPhase::Failed => RuntimeStatusPhase::Failed,
    }
}
...
mod tests {
    ...
    use roseui_realtime::EventBroadcaster;
    use roseui_runtime::{NodeRuntimeProgress, NodeRuntimeProgressPhase};
    use std::io::Write;
    use std::sync::Mutex;
    use tracing::Level;
