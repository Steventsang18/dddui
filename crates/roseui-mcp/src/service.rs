...
use roseui_db::{CreateMcpServerParams, IMcpServerRepository, UpdateMcpServerParams};
...
mod tests {
    use super::*;
    use roseui_api_types::{ImportMcpServerRequest, McpTransport};
    use roseui_common::{McpServerStatus, TimestampMs};
    use roseui_db::models::McpServerRow;
    use roseui_db::{CreateMcpServerParams, DbError, UpdateMcpServerParams};
    ...
    async fn persist_test_result_records_success_status_and_tools() {
        ...
        let result = McpConnectionTestResult {
            success: true,
            tools: Some(vec![roseui_api_types::McpToolResponse {
                name: "read_file".into(),
        ...
        assert_eq!(updated.last_test_status, roseui_common::McpServerStatus::Connected);
    ...
    async fn persist_test_result_records_error_and_clears_tools() {
        ...
        let updated = svc.get_server(TEST_USER_ID, &created.id).await.unwrap();
        assert_eq!(updated.last_test_status, roseui_common::McpServerStatus::Error);
