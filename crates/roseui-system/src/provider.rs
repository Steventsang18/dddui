...
use roseui_api_types::{CreateProviderRequest, ProviderResponse, UpdateProviderRequest};
use roseui_common::{decrypt_string, encrypt_string};
use roseui_db::{CreateProviderParams, IProviderRepository, UpdateProviderParams, models::Provider};
...
mod tests {
    ...
    use roseui_db::{SqliteProviderRepository, init_database_memory};
    ...
    fn validate_create_bedrock_allows_empty_base_url_and_api_key() {
        let req = CreateProviderRequest {
            ...
            base_url: "".into(),
            api_key: "".into(),
            bedrock_config: Some(roseui_api_types::BedrockConfig {
                auth_method: roseui_api_types::BedrockAuthMethod::Profile,
