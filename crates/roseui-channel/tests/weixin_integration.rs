...
mod weixin_tests {
    ...
    use roseui_channel::manager::{ChannelManager, PluginFactory};
    use roseui_channel::plugin::ChannelPlugin;
    use roseui_channel::plugins::weixin::WeixinPlugin;
    use roseui_channel::types::{PluginConfig, PluginCredentials, PluginStatus, PluginType};
    ...
    fn login_event_qr_serializes_correctly() {
        use roseui_channel::plugins::weixin::weixin_login_stream;
