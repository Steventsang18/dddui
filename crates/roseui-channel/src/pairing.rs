...
use roseui_api_types::{PairingRequestedPayload, UserAuthorizedPayload, WebSocketMessage};
use roseui_common::{TimestampMs, generate_id, now_ms};
use roseui_db::IChannelRepository;
use roseui_db::models::{AssistantUserRow, PairingCodeRow};
