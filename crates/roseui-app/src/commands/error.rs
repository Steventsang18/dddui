...
pub(crate) enum CliBoundaryCode {
    ...
    CliDoctorFts5Missing,
    CliPrepareManagedResourcesFailed,
    CliMigrateDatabaseFailed,
    CliMigrateDryRunFailed,
    McpEnvMissing,
    McpEnvInvalidPort,
    McpStdinTty,
    McpStdinReadFailed,
...
impl CliBoundaryCode {
    pub(crate) fn as_str(self) -> &'static str {
        match self {
            ...
            Self::CliDoctorFts5Missing => "CLI_DOCTOR_FTS5_MISSING",
            Self::CliPrepareManagedResourcesFailed => "CLI_PREPARE_MANAGED_RESOURCES_FAILED",
            Self::CliMigrateDatabaseFailed => "CLI_MIGRATE_DATABASE_FAILED",
            Self::CliMigrateDryRunFailed => "CLI_MIGRATE_DRY_RUN_FAILED",
            ...
            Self::McpWikiDbOpenFailed => "MCP_WIKI_DB_OPEN_FAILED",
        }
    }
