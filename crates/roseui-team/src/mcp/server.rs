...
use roseui_api_types::TeamSendMessageQueuedResponse;
...
async fn handle_tools_list(
    ...
    let context = TeamToolContext {
        ...
        transport: roseui_api_types::TeamToolTransport::Mcp,
    };
...
mod tests {
    use super::*;
    use roseui_api_types::{TeamRunTargetRole, TeamSlotWorkPayload, TeamSlotWorkState};
