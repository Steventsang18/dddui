...
// when switching conversations / projects. Key: `roseui_preview:<scope>`.
const previewScopeStorageKey = (scope: string): string => `roseui_preview:${scope}`;
...
export const PreviewProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // to `roseui_preview:<scope>`, debounced. Keeps activeTabIdRef in sync eagerly.
  useEffect(() => {
