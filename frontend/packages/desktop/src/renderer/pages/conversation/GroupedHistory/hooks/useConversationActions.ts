...
export const useConversationActions = ({
  ...
  /**
   * Remove project state — rendered via RoseModal in the GroupedHistory component.
   * Uses project's design system: RoseModal component with danger-styled action button.
   */
