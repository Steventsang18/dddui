...
const SKILLS_MARKET_DETAILS_ZH = 'https://github.com/iOfficeAI/RoseUi/discussions/1326';
const SKILLS_MARKET_DETAILS_EN = 'https://github.com/iOfficeAI/RoseUi/discussions/1325';
