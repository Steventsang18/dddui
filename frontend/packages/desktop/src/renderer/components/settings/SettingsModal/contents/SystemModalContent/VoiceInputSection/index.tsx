        ...
        <>
          ...
          <Form layout='horizontal' labelAlign='left' className='space-y-12px'>
            <Form.Item label={t('settings.speechToTextSource')}>
              <RoseSelect value={source} onChange={handleSourceChange}>
                <RoseSelect.Option value='openai'>{t('settings.speechToTextSourceOpenAI')}</RoseSelect.Option>
                <RoseSelect.Option value='deepgram'>{t('settings.speechToTextSourceDeepgram')}</RoseSelect.Option>
                <RoseSelect.Option value='custom'>{t('settings.speechToTextSourceCustom')}</RoseSelect.Option>
              </RoseSelect>
            </Form.Item>
                  ...
                  const badgeText =
                    capability === 'supported'
                      ...
                      : capability === 'unsupported'
                        ...
                        : null;
                  return (
                    <RoseSelect.Option key={model} value={model}>
                      {model}
            ...
            <Form.Item label={t('settings.speechToTextLanguage')}>
              <RoseSelect value={activeLanguage} onChange={handleLanguageChange}>
                {SPEECH_LANGUAGE_OPTIONS.map((option) => (
                  <RoseSelect.Option key={option.value || 'auto'} value={option.value}>
