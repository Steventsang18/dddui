...
const FeedbackReportModal: React.FC<FeedbackReportModalProps> = ({
  ...
  // "Solve via chat": hand the report to the DoDidDoneUi Butler for on-the-spot
  ...
  return (
    <RoseModal
      ...
      // RoseModal (e.g. the Agent editor). Arco's default z-index stacks
