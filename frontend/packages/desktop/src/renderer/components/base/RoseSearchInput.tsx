...
const RoseSearchInput = forwardRef<HTMLInputElement, RoseSearchInputProps>((props, ref) => {
  const {
    value,
    onChange,
    placeholder,
...
RoseSearchInput.displayName = 'RoseSearchInput';

export default RoseSearchInput;
