 ...
 */
export interface RoseCollapseProps {
 ...
 */
export interface RoseCollapseItemProps {
 ...
 */
const RoseCollapseItem: React.FC<RoseCollapseItemProps> = ({ children }) => <>{children}</>;
RoseCollapseItem.displayName = 'RoseCollapseItem';
 ...
 * ```tsx
 * // 基本用法 / Basic usage
 * <RoseCollapse defaultActiveKey={['1']}>
 *   <RoseCollapse.Item name="1" header="面板1">
 *     内容1
 *   </RoseCollapse.Item>
 *   <RoseCollapse.Item name="2" header="面板2">
 *     内容2
 *   </RoseCollapse.Item>
 * </RoseCollapse>
 *
 * // 手风琴模式 / Accordion mode
 * <RoseCollapse accordion defaultActiveKey="1">
 *   <RoseCollapse.Item name="1" header="面板1">内容1</RoseCollapse.Item>
 *   <RoseCollapse.Item name="2" header="面板2">内容2</RoseCollapse.Item>
 * </RoseCollapse>
 *
 * // 自定义图标 / Custom icon
 * <RoseCollapse
 ...
 * ```
 */
const RoseCollapseComponent: React.FC<RoseCollapseProps> & { Item: typeof RoseCollapseItem } = ({
  children,
  className,
  defaultActiveKey,
  activeKey,
  ...
  const items = useMemo(() => {
    return React.Children.toArray(children).filter((child): child is React.ReactElement<RoseCollapseItemProps> => {
      return React.isValidElement(child) && child.type === RoseCollapseItem;
    });
  }, [children]);
...
RoseCollapseComponent.Item = RoseCollapseItem;

export default RoseCollapseComponent;
