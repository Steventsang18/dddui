export const WORKSPACE_TOGGLE_EVENT = 'roseui-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'roseui-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'roseui-workspace-has-files';
