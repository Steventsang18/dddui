...
// Telemetry (Sentry) is disabled by default — local-only agent platform, no
// outbound crash data. See docs/编译遵守原则.md §安全底线 / §模块 6.
...
function captureRuntimeInstallationIntegrityFailure(event: IRuntimeStatusEvent): void {
  ...
  // Telemetry (Sentry) disabled by default — local-only agent platform.
}
