 ...
 * 会话来源类型 - 标识会话创建的来源
 */
export type ConversationSource = 'roseui' | 'telegram' | 'lark' | 'dingtalk' | 'weixin' | 'wecom' | (string & {});
...
interface IChatConversation<T, Extra> {
  ...
  /** 会话来源，默认为 roseui / Conversation source, defaults to roseui */
...
export type TChatConversation =
  ...
  // the roseui-common crate's enums.rs and factory.rs.
...
export interface IMcpServer {
  ...
  /** Built-in MCP server managed by RoseUi (hide edit/delete in UI) */
  builtin?: boolean;
}
...
export const BUILTIN_IMAGE_GEN_NAME = 'roseui-image-generation';
export const BUILTIN_IMAGE_GEN_LEGACY_NAMES = ['RoseUi Image Generation', BUILTIN_IMAGE_GEN_ID] as const;
