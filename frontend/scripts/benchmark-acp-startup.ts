...
function getLogFilePath(): string {
  ...
  // Dev mode uses "RoseUi-Dev", production uses "RoseUi"
  const devPath = path.join(os.homedir(), 'Library', 'Logs', 'RoseUi-Dev', `${today}.log`);
  const prodPath = path.join(os.homedir(), 'Library', 'Logs', 'RoseUi', `${today}.log`);
