...
for f in RoseUi-1.0.0-win-x64.exe RoseUi-1.0.0-win-arm64.exe RoseUi-1.0.0-mac-x64.dmg RoseUi-1.0.0-mac-arm64.dmg RoseUi-1.0.0.deb RoseUi-1.0.0-arm64.deb; do
  if [ ! -f "$OUTPUT_DIR/$f" ]; then
