...
<p align="center">
  <a href="https://x.com/RoseUi/status/2079493379914961069">
    <img src="../../resources/kimi/contributor-bonus-black-blue.jpg" alt="RoseUi × Kimi Katkıda Bulunan Bonusu" width="600">
  </a>
</p>

<p align="center">
  🎁 <strong>RoseUi × Kimi Ortaklığı</strong>: Katkıda bulunanlara <strong>ücretsiz premium Kimi "Allegretto" planları (aylık $39 · ¥199 değerinde)</strong>!
</p>

<h3 align="center">
  <a href="https://x.com/RoseUi/status/2079493379914961069">Kampanya detaylarını ve talep yöntemini görün →</a>
</h3>

<p align="center">
  <sub><strong>Kimi K3</strong> yayında ve RoseUi'de kutudan çıktığı gibi çalışıyor — <a href="https://www.kimi.com/code?aff=roseui" target="_blank">Kimi For Coding planı edinin</a> veya API anahtarı alın (<a href="https://platform.kimi.ai?aff=roseui" target="_blank">Global</a> / <a href="https://platform.kimi.com?aff=roseui" target="_blank">Çin</a>)</sub>
</p>
...
[🤔 Neden RoseUi'yi Seçmelisiniz?](#-neden-roseui-claude-cowork-yerine) ·
...
**RoseUi sadece bir sohbet istemcisi değil.** AI Agents'ın bilgisayarınızda sizinle çalıştığı bir Cowork platformudur — dosya okuma, kod yazma, web'de gezinme ve görevleri otomatikleştirme. Agent'ın yaptığı her şeyi görürsünüz ve her zaman kontrol sizdedir.

|                                        | Geleneksel AI Sohbet İstemcileri | **RoseUi (Cowork)**                                                                                                             |
| :------------------------------------- | :------------------------------- | :------------------------------------------------------------------------------------------------------------------------------ |
...
RoseUi tam bir AI Agent motoru ile birlikte gelir. CLI Agent'ları ayrı olarak kurmanızı gerektiren araçların aksine, **RoseUi kurduğunuz anda çalışır**.
...
Zaten Claude Code, Codex, Hermes Agent veya OpenClaw kullanıyorsanız, RoseUi bunları otomatik olarak algılar ve hepsiyle Cowork yapmanıza izin verir — yerleşik Agent ile birlikte.

**Desteklenen Agents:** Yerleşik Agent (sıfır kurulum) • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • Aion CLI (aionrs, RoseUi ile birlikte dağıtılan Rust tabanlı arka uç servisi) • Snow CLI • Hermes Agent • Cursor Agent ve daha fazlası
...
- **Paralel çoklu agent çalıştırma** — Leader görevleri alt görevlere bölerek paralel çalışan Teammate Agent'lara devreder; her Teammate ACP (Agent Communication Protocol, RoseUi'nin çoklu agent koordinasyon katmanı), Gemini veya Aionrs aracılığıyla kendi modelini kullanır
...
Diğer AI uygulamaları size API anahtarınızla bir sohbet kutusu verir. **RoseUi size tam bir Cowork Agent verir.**
...
Aynı Agent yetenekleri — dosya okuma/yazma, web arama, görüntü oluşturma, araç kullanımı — hangi modelin güç verdiğine bakılmaksızın. RoseUi bulut hizmetleri ve yerel dağıtımlar dahil **30+ AI platformunu** destekler.
...
RoseUi ayrıca [NewAPI](https://github.com/QuantumNous/new-api) ağ geçidi hizmetini destekler — çeşitli LLM'leri toplayan ve dağıtan birleşik bir AI model merkezi. Çeşitli görev gereksinimlerini karşılamak için aynı arayüzde farklı modeller arasında esnek bir şekilde geçiş yapın.
...
- **Üç katmanlı Beceriler** — Yerleşik beceriler (RoseUi ile birlikte gelen), özel beceriler (kendinizinkiler) ve Extension becerileri (üçüncü taraf uzantılar tarafından katkıda bulunulan); beceri göstergesi ile konuşma başına etkinleştirin/devre dışı bırakın
...
RoseUi önceden tanımlanmış yeteneklere sahip **21 profesyonel asistan** içerir, özel beceriler aracılığıyla genişletilebilir:
...
_7/24 AI asistanınız — RoseUi'ye herhangi bir cihazdan, her yerden erişin._
...
> **Kurulum:** RoseUi Ayarları → WebUI Ayarları → Kanal, Bot Token'ı yapılandırın.
...
> [Uzaktan İnternet Erişimi Öğreticisi](https://github.com/iOfficeAI/RoseUi/wiki/Remote-Internet-Access-Guide-Chinese)
...
- **Uyanık kal** — RoseUi görevler aktifken sistem uyku moduna geçmeyi otomatik olarak önler ve uyandıktan sonra kaçırılan tetikleyicileri algılar
...
> [Görüntü oluşturma modeli yapılandırma kılavuzu](https://github.com/iOfficeAI/RoseUi/wiki/RoseUi-Image-Generation-Tool-Model-Configuration-Guide)
...
## 🤔 Neden RoseUi, Claude Cowork Yerine?
...
RoseUi **ücretsiz ve açık kaynaklı bir Çoklu AI Agent Masaüstü** uygulamasıdır. Sadece macOS'ta çalışan ve Claude'ye kilitli Claude Cowork ile karşılaştırıldığında, RoseUi tam model, çapraz platform geliştirilmiş versiyonudur.

| Boyut           | Claude Cowork | RoseUi                                            |
| :-------------- | :------------ | :------------------------------------------------ |
...
C: <strong>Hayır.</strong> RoseUi kurulumdan hemen sonra çalışan yerleşik bir AI Agent'a sahiptir. Başlamak için herhangi bir API anahtarı girmeniz yeterli. Ayrıca Claude Code veya Gemini CLI gibi CLI araçlarınız da kuruluysa, RoseUi bunları otomatik olarak algılayacak ve daha fazla yetenek için entegre edecektir.
</details>

<details>
<summary><strong>S: RoseUi ile ne yapabilirim?</strong></summary>
C: RoseUi sizin <strong>özel Cowork çalışma alanınızdır</strong>. Yerleşik Agent klasörleri toplu olarak organize edebilir, Excel verilerini işleyebilir, belgeler oluşturabilir, web'de arama yapabilir ve görüntüler oluşturabilir. Çoklu Agent Modu ile aynı arayüz üzerinden Claude Code, Codex ve diğer güçlü CLI Agent'larından da yararlanabilirsiniz.
</details>

<details>
<summary><strong>S: Ücretsiz mi?</strong></summary>
C: RoseUi tamamen ücretsiz ve açık kaynaklıdır. Yalnızca seçtiğiniz sağlayıcının API kullanımı için ödeme yaparsınız ve tercih ettiğiniz herhangi bir sağlayıcıdan API anahtarları kullanabilirsiniz.
</details>
...
## İnsanların RoseUi'yi Nasıl Kullandığını Görün
...
> **RoseUi hakkında bir video yaptınız mı?** [X'te bize bildirin](https://x.com/RoseUi) ve burada öne çıkaralım!
...
- [📖 Tam Kurulum Kılavuzu](https://github.com/iOfficeAI/RoseUi/wiki/Getting-Started) — İndirmeden yapılandırmaya kadar detaylı adımlar
- [⚙️ LLM Yapılandırma Kılavuzu](https://github.com/iOfficeAI/RoseUi/wiki/LLM-Configuration) — Çoklu platform AI model yapılandırması
- [🤖 Çoklu Agent Modu Kurulumu](https://github.com/iOfficeAI/RoseUi/wiki/ACP-Setup) — Terminal AI Agent'larını entegre edin
- [🔌 MCP Araç Yapılandırması](https://github.com/iOfficeAI/RoseUi/wiki/MCP-Configuration-Guide) — Model Context Protocol sunucu kurulumu
- [🌐 WebUI Yapılandırma Kılavuzu](https://github.com/iOfficeAI/RoseUi/wiki/WebUI-Configuration-Guide) — Tam WebUI kurulum ve yapılandırma öğreticisi

**🎯 Kullanım Senaryoları**

- [📁 Dosya Yönetimi](https://github.com/iOfficeAI/RoseUi/wiki/file-management) — Akıllı dosya organizasyonu
- [📊 Excel İşleme](https://github.com/iOfficeAI/RoseUi/wiki/excel-processing) — AI destekli veri işleme
- [🎨 Görüntü Oluşturma](https://github.com/iOfficeAI/RoseUi/wiki/RoseUi-Image-Generation-Tool-Model-Configuration-Guide) — AI görüntü oluşturma
- [📚 Daha Fazla Kullanım Senaryosu](https://github.com/iOfficeAI/RoseUi/wiki/Use-Cases-Overview)

**❓ Destek ve Yardım**

- [❓ SSS](https://github.com/iOfficeAI/RoseUi/wiki/FAQ) — Sorular ve sorun giderme
- [🔧 Yapılandırma ve Kullanım Öğreticileri](https://github.com/iOfficeAI/RoseUi/wiki/Configuration-Guides) — Tam yapılandırma dokümantasyonu
...
- [GitHub Discussions](https://github.com/iOfficeAI/RoseUi/discussions) — fikirleri paylaşın ve ipuçları alışverişi yapın
- [Sorun Bildir](https://github.com/iOfficeAI/RoseUi/issues) — hatalar ve özellik istekleri
- [Sürüm Güncellemeleri](https://github.com/iOfficeAI/RoseUi/releases) — en son sürümü alın
...
RoseUi yerel geliştirme iki depo kullanır: Electron frontend için RoseUi ve yerel backend için RoseCore. macOS, Linux ve Windows için tam kurulum adımları için [Development Guide](../contributing/development.md) belgesine bakın.
...
[Hata Bildir](https://github.com/iOfficeAI/RoseUi/issues) · [Özellik İste](https://github.com/iOfficeAI/RoseUi/issues)
