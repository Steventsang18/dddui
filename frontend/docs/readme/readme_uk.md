<p align="center">
  <img src="../../resources/roseui-banner-1.png" alt="RoseUi - Спільна робота з AI-агентами" width="100%">
</p>

<p align="center">
  <img src="https://img.shields.io/github/v/release/iOfficeAI/RoseUi?style=flat-square&color=32CD32" alt="Версія">
  &nbsp;
...
<p align="center">
  <a href="../../readme.md">English</a> | <a href="./readme_ch.md">简体中文</a> | <a href="./readme_tw.md">繁體中文</a> | <a href="./readme_jp.md">日本語</a> | <a href="./readme_ko.md">한국어</a> | <a href="./readme_es.md">Español</a> | <a href="./readme_pt.md">Português</a> | <a href="./readme_tr.md">Türkçe</a> | <a href="./readme_ru.md">Русский</a> | <strong>Українська</strong> | <a href="https://www.roseui.com" target="_blank">Офіційний сайт</a>
</p>

<p align="center">
  <strong>💬 Спільнота:</strong> <a href="https://discord.gg/2QAwJn7Egx" target="_blank">Discord (English)</a> | <a href="../../resources/wx-18.png" target="_blank">微信 (中文群)</a> | <a href="https://twitter.com/AionUI" target="_blank">Twitter</a>
</p>
...
<p align="center">
  <a href="https://x.com/RoseUi/status/2079493379914961069">
    <img src="../../resources/kimi/contributor-bonus-black-blue.jpg" alt="RoseUi × Kimi Бонус для контриб’юторів" width="600">
  </a>
</p>

<p align="center">
  🎁 <strong>Партнерство RoseUi × Kimi</strong>: безкоштовні преміум-плани <strong>Kimi «Allegretto» (вартістю $39/міс · ¥199/міс)</strong> для наших контриб’юторів!
</p>

<h3 align="center">
  <a href="https://x.com/RoseUi/status/2079493379914961069">Деталі акції та як отримати →</a>
</h3>

<p align="center">
  <sub><strong>Kimi K3</strong> вже тут і працює в RoseUi одразу — <a href="https://www.kimi.com/code?aff=roseui" target="_blank">оформіть план Kimi For Coding</a> або отримайте API-ключ (<a href="https://platform.kimi.ai?aff=roseui" target="_blank">Global</a> / <a href="https://platform.kimi.com?aff=roseui" target="_blank">Китай</a>)</sub>
</p>
...
[🤔 Чому варто обрати RoseUi?](#-чому-варто-обрати-roseui-замість-claude-cowork) ·
...
**RoseUi — це більше, ніж просто чат-клієнт.** Це платформа для спільної роботи (Cowork), де AI-агенти працюють пліч-о-пліч із вами на вашому комп'ютері: читають файли, пишуть код, шукають в інтернеті та автоматизують завдання. Ви бачите все, що робить агент, і завжди зберігаєте контроль.

|                                    | Традиційні AI чат-клієнти | **RoseUi (Cowork)**                                                                                                  |
| :--------------------------------- | :------------------------ | :------------------------------------------------------------------------------------------------------------------- |
...
RoseUi постачається з повноцінним рушієм AI-агентів. На відміну від інструментів, що вимагають окремого встановлення CLI-агентів, **RoseUi працює одразу після встановлення**.
...
Якщо ви вже використовуєте Claude Code, Codex, Hermes Agent або OpenClaw, RoseUi автоматично виявить їх і дозволить працювати з усіма ними разом із вбудованим агентом.

**Підтримувані агенти:** Вбудований агент • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • Aion CLI (aionrs, Rust-бекенд-сервіс, що постачається з RoseUi) • Snow CLI • Hermes Agent • Cursor Agent та інші
...
- **Паралельне виконання кількох агентів** — Leader ділить завдання на підзадачі і делегує паралельно працюючим Teammate-агентам; кожен Teammate використовує свою модель через ACP (Agent Communication Protocol, шар координації мульти-агентності RoseUi), Gemini або Aionrs
...
Інші додатки дають лише вікно чату. **RoseUi дає повноцінного агента для спільної роботи.**
...
Ті ж самі можливості — читання/запис файлів, веб-пошук, генерація зображень — незалежно від того, яка модель використовується. RoseUi підтримує **30+ AI-платформ**.
...
- **Трирівневі навички** — вбудовані навички (поставляються з RoseUi), власні навички (ваші особисті) та Extension-навички (від сторонніх розширень); вмикайте/вимикайте для кожної розмови з індикатором навичок
...
**Навички**: навички з трьох джерел — вбудовані (поставляються з RoseUi), власні (ваші особисті) та Extension (через Extension SDK). Вбудовані: `pptx`, `docx`, `pdf`, `xlsx`, `mermaid` та інші.
...
- **Режим без сну** — RoseUi автоматично запобігає переходу системи у сплячий режим, поки активні завдання, та визначає пропущені тригери після пробудження
...
<p align="center">
  <img src="../../resources/roseui sort file 2.gif" alt="Керування файлами" width="800">
</p>

---

## 🤔 Чому варто обрати RoseUi замість Claude Cowork?

RoseUi — це **безкоштовний Multi-AI Agent десктоп**. На відміну від Claude Cowork, який працює лише на macOS і обмежений лише Claude, RoseUi — це версія з підтримкою всіх моделей та платформ.
...
- [GitHub Discussions](https://github.com/iOfficeAI/RoseUi/discussions) — діліться ідеями
- [Повідомити про проблему](https://github.com/iOfficeAI/RoseUi/issues) — баги та запити функцій
...
Локальна розробка RoseUi використовує два репозиторії: RoseUi для Electron-фронтенду та RoseCore для локального backend. Повні інструкції для macOS, Linux і Windows наведені в [Development Guide](../contributing/development.md).
