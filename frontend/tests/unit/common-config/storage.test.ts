...
describe('storage runtime exports', () => {
  ...
  describe('EnvStorage', () => {
    ...
    it('set/get roundtrip with roseui.dir object', async () => {
      const dirs = {
        workDir: '/a',
        cacheDir: '/b',
        dataDir: '/c',
      ...
      await EnvStorage.set('roseui.dir', dirs);
      const result = await EnvStorage.get('roseui.dir');
  ...
  describe('storage isolation', () => {
    it('ConfigStorage and EnvStorage do not share state', async () => {
      ...
      await EnvStorage.set('roseui.dir', {
        workDir: '/x',
        cacheDir: '/y',
        dataDir: '/z',
        homeDir: '/h',
      ...
      const envDir = await EnvStorage.get('roseui.dir');
