...
function legacyConversation(type: 'gemini' | 'codex' | 'openclaw-gateway' | 'nanobot' | 'remote'): TChatConversation {
  return {
    ...
    type,
    model: {},
    extra: { workspace: '/tmp/roseui-history' },
    status: 'finished',
    source: 'roseui',
    created_at: 1,
    modified_at: 1,
        ...
        conversation={
          {
            ...
            type: 'acp',
            model: {},
            extra: { workspace: '/tmp/roseui-history', backend: 'claude' },
            status: 'finished',
            source: 'roseui',
            created_at: 1,
            modified_at: 1,
        ...
        conversation={
          {
            ...
            type: 'acp',
            model: {},
            extra: { workspace: '/tmp/roseui-history', backend: 'claude', current_model_id: 'model-1' },
            status: 'finished',
            source: 'roseui',
            created_at: 1,
            modified_at: 1,
